...
const URL_TO_FETCH = '/api/rss/cnbc-international';

const CNBCInternationalNews = () => {
	...
	return (
		<>
			<Head>
				<title>Peter Jones | CNBC International News</title>
			</Head>
			<div className='feeds-container content'>
				<div className={styles.newsfeedHeader}>
					<Image
						src='/images/news/cnbc.jpg'
						alt='cnbc international news'
						width='100'
						height='100'
						layout='fixed'
					/>{' '}
					<h2>CNBC International News</h2>
				</div>
...
export default CNBCInternationalNews;
