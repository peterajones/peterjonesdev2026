...
const FEED_URL = 'https://www.cbc.ca/webfeed/rss/rss-topstories';
...
const CBCTopStories = () => {
	...
	return (
		<>
			<Head>
				<title>Peter Jones | CBC News Top Stories</title>
			</Head>
